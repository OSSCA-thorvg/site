...
Overview uses 1280×2230. Effect Pipeline uses 960×800; its five stage scenes use 960×540;
...
| composite | endComposite/rasterDirectImage | inputs → restore → source term → Canvas term → write | Exact byte contributions and final native Canvas |
